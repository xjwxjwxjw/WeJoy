  <!-- content start -->
  <script src={{url("/admin/js/announcement_app.js")}}></script>
<!-- <div id="slide-target"> -->
      ...
      <div class="am-u-md-3 am-cf">
        <div class="am-fr">
          <div class="am-input-group am-input-group-sm">
            <form action={{url('/admin/friendlylink')}} method="get">
    ...
    <div class="am-g">
      <div class="am-u-sm-12">
          <table class="am-table am-table-striped am-table-hover table-main">
            <thead>
              <tr>
                <th class="table-check"><input type="checkbox" /></th><th class="table-id">ID</th><th class="table-title">内容</th><th class="table-title">创建时间</th><th class="table-title">修改时间</th><th class="table-set">操作</th>
              </tr>
          </thead>
          <tbody id="task-list">
            @if(empty($tasks))
                ...
                <td>
                  <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                      ...
                      <button class="am-btn am-btn-default am-btn-xs firstshow am-text-secondary" value="{{$v->id}}"> {{ $v->status==1 ?'隐藏':'显示' }} </button>
          ...
          <div class="am-cf">
             <nav aria-label="...">
               @if( !empty($keepsearch) )
                {{$tasks->appends(['search' => $keepsearch])->links('admin/announcement.page')}}
               @else
                {{$tasks->links('admin/announcement.page')}}
               @endif
            </nav>
          </div>
          <hr />
