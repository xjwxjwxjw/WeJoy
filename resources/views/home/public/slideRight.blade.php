			...
			<div class="W_login_form">
				...
				<div class="info_list username">
					<div class="input_wrap">
						...
						<input id="loginname" type="text" class="W_input" maxlength="128" autocomplete="off" name="username" tabindex="1" placeholder="手机/邮箱/用户名" value="18257725397">
					</div>
				</div>
				<div class="info_list password">
					<div class="input_wrap">
						<span style="background-image:url({{url('home/sprite_login.png')}});" class="login_password"></span>
						<input type="password" class="W_input" maxlength="24" autocomplete="off" name="password" value="asdasd" tabindex="2" placeholder="请输入密码">
					</div>
				</div>
				<!-- 输入验证码 -->
