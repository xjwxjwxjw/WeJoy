                            ...
                            <div class="pf_photo">
                                <p class="photo_wrap">
                                    <a href="javascript:void(0);"title="更换头像">
                                        <img src={{url('home/1.jpg')}} alt="姓名" class="photo">{{--头像--}}
                                    </a>
                                </p>
                            </div>
                            <div class="pf_username">
                                <h1 class="username">姓名</h1>
                                <span class="icon_bed"><a><i class="W_icon icon_pf_male" style="background-image:url({{url('/home/icon.png')}});"></i></a></span>
                            </div>
                                ...
                                <tr>
                                    <td class="S_line1">
                                        <a class="t_link S_txt1" href="">
                                            <strong class="W_f18">24</strong>
                                            <span class="S_txt2">关注</span>
                                        </a>
                                    </td>
                                    <td class="S_line1">
                                        <a class="t_link S_txt1" href="">
                                            <strong class="W_f18">31</strong>
