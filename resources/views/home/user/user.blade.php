                ...
                <div class="PCD_header">
                    <div class="pf_wrap" style="background-image:url({{url('/home/bg.jpg')}});background-size:100% 100%;">
                        ...
                        <div class="shadow  S_shadow">
                            <div class="pf_photo">
                                <p class="photo_wrap">
                                    <img id="ddicon" src='<?= empty($userinfo->icon)?url('/home/image/default.jpg'):url($userinfo->icon) ?>' alt={{$user->name}} class="photo" width="100" height="100">{{--头像--}}
                                </p>
                            </div>
                            ...
                            <div class="list_wrap">
                                <div class="fb_div">
                                    <ul class="list_ul">
                                        ...
                                        @if(count(\App\UserFans::where('uid',$id)->where('uid_ed',Cookie::get('UserId'))->where('status',1)->get()) > 0)
                                            <li class="item">
                                        ...
                                        @endif
                                        @if(count(\App\UserFans::where('uid',$id)->where('uid_ed',Cookie::get('UserId'))->where('status',2)->get()) > 0)
                                            <li class="item">
