        ...
        <div class="result_wrap">
            <div class="result_content">
                <table class="list_tab">
                    ...
                    <tr>
                        <td class="tc"><?php echo e($role->id); ?></td>
                        <td><?php echo e($role->name); ?></td>
                        <td><?php echo e($role->display_name); ?></td>
                        <td><?php echo e($role->description); ?></td>
                        <td><?php echo e($role->perms); ?></td>
                        <td>
                            <a href="/attach-permission/<?php echo e($role->id); ?>">分配权限</a>
                            <a href="/role-update/<?php echo e($role->id); ?>">修改</a>
                            <a href="/role-delete/<?php echo e($role->id); ?>">删除</a>
                        </td>
                    </tr>
