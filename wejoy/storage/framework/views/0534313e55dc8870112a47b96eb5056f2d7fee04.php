    ...
    <table class='table table-striped table-bordered table-hover'>
        ...
        <?php $__currentLoopData = $result; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
            <tr>
                ...
                <td><a href="<?php echo url('/admin/myIndex/edit/'.$value->id); ?>" class="btn btn-info">修改</a><a href="<?php echo url('/admin/myIndex/del/'.$value->id); ?>" class="btn btn-danger">删除</a></td>
            </tr>
